...
} else if (bundle.includes(PREVIOUS_BROKEN_MATERIAL)) {
  bundle = bundle.replace(PREVIOUS_BROKEN_MATERIAL, AMP_STYLE_MATERIAL);
} else if (!bundle.includes('let T,r;if(h==B.mjtGeom.mjGEOM_MESH.value')) {
